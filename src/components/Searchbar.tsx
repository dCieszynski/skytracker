    ...
    <div className="flex flex-col mt-4 w-full">
      <div className="flex flex-col gap-2 border-2 p-4 rounded-2xl">
        <div className="flex justify-between">
          ...
          <input className="w-1/4 text-black" type="text" ref={minLatInput} />
        </div>
        <div className="flex justify-between">
          <label>MaxLatitude</label>
          <input className="w-1/4 text-black" type="text" ref={maxLatInput} />
        </div>
        <div className="flex justify-between">
          <label>MinLongitude</label>
          <input className="w-1/4 text-black" type="text" ref={minLngInput} />
        </div>
        <div className="flex justify-between">
          <label>MaxLongitude</label>
          <input className="w-1/4 text-black" type="text" ref={maxLngInput} />
        </div>
        <button
